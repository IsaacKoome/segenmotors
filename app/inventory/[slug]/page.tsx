...
import { Car, allCars, getCarBySlug, getRelatedCars } from "@/lib/carData"; // Import centralized data
import { 
  Calendar, 
  Gauge, 
  Fuel, 
...
export default async function CarDetailPage({
  ...
  const car = getCarBySlug(slug); // Use helper function from centralized data
  ...
  const relatedCars = getRelatedCars(car.linkSlug, 3);
